...
universe. It falls on the fraction, not the expansion rate: \Hz\ recovers
the input value at every depth tested, and a factor-of-two error in the
assumed AGN density moves it by \HzDensityShiftFactorTwoDeep~\kmsmpc\ while
the catalogs remain more than \CompMTwenty\ per cent complete, by
\HzDensityShiftFactorTwo~\kmsmpc\ at \CompMEighteen\ per cent. The
...
\SeedLnBFmin\ to \SeedLnBFmax\ $e$-folds of evidence. The third is the source population, held at its input values
