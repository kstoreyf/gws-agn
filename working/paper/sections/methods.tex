...
pixel-by-pixel sky normalisation every occupied pixel is rescaled to unit weight and the
...
complete-catalog analyses of this paper the missing budget is switched off;
