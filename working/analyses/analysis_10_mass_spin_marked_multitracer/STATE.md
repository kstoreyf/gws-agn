...
**Stage (2026-09-25 23:30 EDT): OWNER FOLLOW-UPS 1–3 COMPLETE.** (3) Δμ_χ extended to 0.235 (jx rows), all C10-J axes contained, numbers unchanged. (1) C10-2: `c10_event_routing.py`, 12 H0 nodes verified to 2 ULP; the mass mark shifts H0 (70.5 → 68.0) through a spread, non-routing population effect; the spin mark is routing-concentrated; marks add curvature at a common H0 but the peak moves to where the likelihood is ~2× flatter; fixed-f P1/P0 width 0.87 → 1.12 over f. (2) C10-3: generator `--branch_frac_independent`; single-tracer twins; B5M 68.86 [65.12, 74.64] and B0M 67.38 [64.50, 70.18] both recover 67.74; width B5M/B0M 1.66 (f–mass-scale trade); unmarked B5U ≥ 88.9 (truncated). Previous stage line follows.

**Stage (2026-09-24 06:40 EDT): COSMOLOGY STAGE COMPLETE; AT THE FINAL OWNER GATE.** C10-J (H0, f, Δμ_χ, Δμ_G free; 72,930 cells, 61.2 GPU-h, 0 rejected): H0 67.66 [66.34, 68.80] (90% [65.39, 69.43]), planted 67.74 inside 68%; f 0.274, Δμ_G 4.80, Δμ_χ 0.1185; ρ(H0, Δμ_G) −0.25. Against C10-S on the matched lattice: −2.94 in H0, width ratio 1.088 / 1.007, so the marks remove a misspecification offset and give no precision gain. Releasing H0 widens the mark posteriors by ≤ 4% on matched lattices. Δμ_χ top edge 1.6e-5 of the peak; tail mass 3.9e-7, judged immaterial. Chunk 7 was resubmitted (1337582) after a TaskProlog node fault. Open owner decisions: the C10-2 H0-curvature split (< 1 GPU-h) and the C10-3 label-scramble control. Previous stage line follows.
